                    ...
                    <div
                        ...
                        @else
                            <div class="w-full h-full flex items-center justify-center bg-surface-container-low">
                                <span class="material-symbols-outlined text-[80px] text-outline-variant">image_not_supported</span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-md pt-lg border-t border-outline-variant/30">
                        ...
                        @if ($product->sku)
                            <div class="flex items-center gap-sm">
                                ...
                                <span class="font-caption text-caption uppercase tracking-wider">SKU: {{ $product->sku }}</span>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="max-w-container-max mx-auto relative z-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-xl">
                        ...
                        <div
                            ...
                            <p class="font-body-md text-body-md text-on-surface-variant">Rigorous third-party testing for
                        ...
                        <div class="mt-xl grid grid-cols-1 md:grid-cols-2 gap-gutter">
                            ...
                            @if ($product->ingredients)
                                <div class="p-md bg-surface/50 rounded-[24px]">
                                    ...
                                    <p class="font-body-md text-on-surface-variant mt-xs">{{ $product->ingredients }}</p>
                                </div>
                            @endif
                        </div>
                    @endif
                        ...
                        <div class="flex flex-col gap-md">
                            <div class="flex gap-md group">
                                ...
                                <div class="flex flex-col gap-xs">
                                    ...
                                    <p class="font-body-md text-body-md text-on-surface-variant">Add 1 teaspoon (approx. 2g)
                            ...
                            <div class="flex gap-md group">
                                ...
                                <div class="flex flex-col gap-xs">
                                    ...
                                    <p class="font-body-md text-body-md text-on-surface-variant">Mix with warm water, fresh
                    ...
                    <div class="order-1 lg:order-2">
                        @if ($product->images->count() >= 2)
                            <div class="grid grid-cols-2 gap-md">
                                <div class="aspect-square rounded-[24px] overflow-hidden shadow-lg transform translate-y-8">
                ...
                <section class="py-xl px-margin-desktop bg-surface-container-high/30">
                    <div class="max-w-container-max mx-auto">
                        <div class="flex justify-between items-end mb-xl">
                            <div class="flex flex-col gap-xs">
                                <span
                                    class="font-label-md text-label-md text-secondary uppercase tracking-widest">Enhance Your
                                    Journey</span>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                            @foreach ($relatedProducts->take(3) as $relatedProduct)
                                @include('themes.natural.public.products.partial.product-card', ['product' => $relatedProduct])
                            @endforeach
                        </div>
                    </div>
                </section>
