    ...
    <x-slot name="main">
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div
                                            class="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg border border-gray-200 dark:border-gray-700 mb-3 space-y-3">
                                            <div class="flex items-center justify-between">
                                                <span
                                                    class="text-xs font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider">AI
                                                    Marketing Generator</span>
                                            ...
                                            <div class="grid grid-cols-2 gap-2 text-xs">
                                                <div>
                                                    <label
                                                        class="block text-gray-500 dark:text-gray-400 mb-1">Language</label>
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-gray-500 dark:text-gray-400 mb-1">Tone</label>
                                                    <select id="ai-tone"
                                                        class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white py-1 px-2 text-xs">
                                            ...
                                            <div>
                                                <label
                                                    class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Target
        ...
        <script>
            document.getElementById('generate-description').addEventListener('click', function() {
                ...
                const category = categoryEl && categoryEl.selectedIndex > 0 ? categoryEl.options[categoryEl
                    .selectedIndex].text : '';
