...
<head>
    ...
    {{-- <link rel="preload" as="style" href="{{ asset('build/assets/app-da813afd.css') }}" />
    <link rel="stylesheet" href="{{ asset('build/assets/app-da813afd.css') }}" />
        ...
        <nav class="flex basis-full items-center w-full mx-auto px-4 sm:px-6 md:px-8" aria-label="Global">
            ...
            <div class="w-full flex items-center justify-end sm:order-3">
                ...
                <div class="flex flex-row items-center justify-end gap-2">
                    ...
                    <a href="{{ route('clear.cache') }}" target="_blank"
                        class="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center gap-2 h-[2.375rem] w-[2.375rem] rounded-full font-medium bg-white text-gray-700 align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-xs dark:bg-gray-800 dark:hover:bg-slate-800 dark:text-gray-400 dark:hover:text-white dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800"
                        data-hs-offcanvas="#hs-offcanvas-right" title="Clear Cache">
                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" viewBox="0 0 16 16">
                            <path
                                d="M.5 1A.5.5 0 0 1 1 .5h14a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H1a.5.5 0 0 1-.5-.5V1zm1 .5v2h13V1H1zM.5 6A.5.5 0 0 1 1 5.5h14a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H1a.5.5 0 0 1-.5-.5V6zm1 .5v2h13V6H1zM.5 11A.5.5 0 0 1 1 10.5h14a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H1a.5.5 0 0 1-.5-.5v-3zm1 .5v2h13v-2H1z" />
                        </svg>
                    </a>
